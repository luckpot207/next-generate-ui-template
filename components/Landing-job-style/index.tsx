...
export default function Landing_JobStyle() {
  return (
    <div className=" mt-[70px] min-w-[100%] px-14 md:pt-2">
      <div className="flex text-center font-bold  lg:text-[65px] mb-24 w-[100%] items-center justify-center md: text-[28px] md:font-[900]">
        <WavyText text="Find The Job Of Your Dreams" />
      </div>
      <div className="grid justify-items-center">
        <div className="lg:inline-grid grid-cols-3 gap-4 md:flex flex-col md: space-y-4 w-full">
          <motion.div
          ...
          >
            <div className="box-border h-32 w-auto mt-4 p-2 border-4 rounded-lg bg-gray-100 shadow-sm">
